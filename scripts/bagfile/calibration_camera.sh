...
# Launch Calibration Camera Node
gnome-terminal -e '/opt/ros/kinetic/bin/roslaunch sensor_fusion calibration_camera.launch' --geometry=50x12+0+300 &
sleep 1s
...
# rviz
gnome-terminal -e '/opt/ros/kinetic/bin/rosrun rviz rviz -d /home/amsl/.rviz/calibration_camera.rviz' --geometry=50x12+2000+750 &
sleep 1s
