...
# DepthImage Creater
gnome-terminal -e "/opt/ros/kinetic/bin/roslaunch sensor_fusion depthimage_creater.launch" --geometry=50x12+0+250 &
sleep 1s
...
# bag
gnome-terminal -e "/opt/ros/kinetic/bin/rosbag play /home/amsl/bagfiles/sq2/2018-07-07-23-50-02.bag --clock -l" --geometry=50x12+2000+500 &
sleep 1s
