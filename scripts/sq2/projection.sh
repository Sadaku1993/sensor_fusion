...
# Coloring PointCloud
gnome-terminal -e '/opt/ros/kinetic/bin/roslaunch sensor_fusion projection_zed0.launch' --geometry=50x12+500+500 &
gnome-terminal -e '/opt/ros/kinetic/bin/roslaunch sensor_fusion projection_zed1.launch' --geometry=50x12+500+750 &
gnome-terminal -e '/opt/ros/kinetic/bin/roslaunch sensor_fusion projection_zed2.launch' --geometry=50x12+750+0 &
sleep 1s
