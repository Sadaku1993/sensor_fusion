...
string source_frame = "/zed2/zed_left_camera";
...
{
    ros::init(argc, argv, "sq_transform_zed2");
    ros::NodeHandle n;
    
    tf::TransformListener listener;
    tf::StampedTransform transform;

    ros::Subscriber sub = n.subscribe("/zed2/coloured_points", 10, Callback);
    ros::Publisher  pub = n.advertise<sensor_msgs::PointCloud2>("/sq_lidar/points/tf/zed2", 10);
